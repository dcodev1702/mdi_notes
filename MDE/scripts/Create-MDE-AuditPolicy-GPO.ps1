...
.PARAMETER GPOName
    Name of the GPO to create. Default: "MDE Audit Policy - Clients"
...
.EXAMPLE
    .\Create-MDE-AuditPolicyGPO.ps1

.EXAMPLE
    .\Create-MDE-AuditPolicyGPO.ps1 -GPOName "Custom MDE Audit" -TargetOU "OU=Workstations,DC=contoso,DC=com"
...
param(
    ...
    [string]$GPOName = "MDE Audit Policy - Clients",
